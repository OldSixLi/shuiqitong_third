        ...
        <div class="panel-body" style="padding:10px;">
          ...
          <el-row :gutter="20" class="detail-row" style="margin-top:15px;">
            ...
            <el-col :span="18" class="right-panel" style="line-height:38px;">
              <el-switch disabled v-model="isSelectCom" active-text="筛选企业" inactive-text="全部企业">
              </el-switch>
            </el-col>
          </el-row>
          <transition name="el-zoom-in-top">
            <el-row :gutter="20" class="detail-row" v-show="isSelectCom">
              ...
              <el-col :span="18" :offset="0">
                <com-slt @result="getComSltResult" :show-back="true" :com-ids="selectedComIds" :btn-text="comBtnText"
                  :read-only="true"></com-slt>
              </el-col>
            </el-row>
          </transition>
