  ...
  <div class="router-block">
    ...
    <div class="center-img">
      ...
      <div style="padding:0 1rem;">
        ...
        <!-- -->
        <mt-field label="所属分局" id="taxs" class="tax-select"  :value="tax" disabled="true" @click.native="showList" style="color:#000;"
          ...
          .then(
            ...
            data => {
              if (data.success) {
                ...
                return Promise.reject(data.message||"验证码输入错误，请修改后重试！");
              }
            })
          .then(
            //进行信息提交
