        ...
        <el-row style="margin-top: 0;">
          ...
          <el-table border :data="tableData" style="min-width: 100%;" :maxHeight="availHeight()" :row-class-name="tableRowClassName">
            ...
            <template v-if="colData.indexOf('姓名')>-1">
              <el-table-column label="提问时间" align="center" minWidth="120">
        ...
        <el-dialog title="问题详情" :visible.sync="showInfoModal" :modal-append-to-body='false' @close="modalClose">
          <div style="margin:0 30px;">
            ...
            <el-row :gutter="20" class="detail-row">
              ...
              <el-col :span="14" class="right-panel">
                <el-input type="textarea" v-model="detailInfo.question" :disabled="true" :autosize="{ minRows: 2, maxRows: 8}" ></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20" class="detail-row">
            ...
            <div v-show="currentState=='detail'">
              ...
              <template v-if="detailInfo.state=='1'">
                ...
                <el-row :gutter="20" class="detail-row">
                  ...
                  <el-col :span="14" class="right-panel">
                    <el-input :value="detailInfo.resName" :disabled="true"></el-input>
                  </el-col>
                </el-row>
                <el-row :gutter="20" class="detail-row">
  ...
  export default {
    ...
    methods: {
      ...
      getTable(
        ...
        quesStartTime = this.searchData.start,
        quesEndTime = this.searchData.end) {
