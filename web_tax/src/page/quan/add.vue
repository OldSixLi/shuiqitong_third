    ...
    <el-col :span="21" :offset="1">
      ...
      <div class="panel panel-default noPadding scroll-target">
        <div class="panel-body" style="padding:10px;">
          ...
          :......::::.......:::..:::::..::..:::::::::..:::::..::..::::..:::::..:::::
          -->
          <el-row :gutter="20" class="detail-row" style="margin-top:15px;">
            <el-col :span="4" class="text-right title line40">
              <el-popover placement="top" title="企业筛选" width="200" trigger="click" content="开启企业筛选后,只有选择列表中企业的员工可回答此问卷。">
          ...
          <transition name="el-zoom-in-top">
            <el-row :gutter="20" class="detail-row" v-show="isSelectCom">
              <el-col :span="4" class="text-right title line40"><b>选择公司</b></el-col>
              <el-col :span="18" :offset="0">
                <com-slt @result="getComSltResult" :show-back="true" :com-ids="selectedComIds" :btn-text="comBtnText"></com-slt>
              </el-col>
            </el-row>
          </transition>
      ...
      <el-row style="margin-top: 15px;">
        <p class="table-title">
          ...
          <span class="text-right" style="float:right;">
            <el-button size="small" type="primary" v-show="quesList.length==0" class="btn btn-primary addQuestion"
              @click="addQuestion()" icon="el-icon-plus"><span class="glyphicon glyphicon-plus"></span>&nbsp;新增问题</el-button>
                ...
                <div v-for="(x,$index) in quesList" class="singleQuestion" style="position: relative;">
                  ...
                  <div class="form-group chooseContain" style="padding-left: 20px;padding-right: 20px;">
                    <el-button type="primary" size="mini" class="btn btn-success addChoose " @click="addOption($index) "
                      style="margin: 0;" :disabled="(!x.qustion.typeArr.includes('1')&&!x.qustion.typeArr.includes('2'))||isDetail">添加选项</el-button>
                    <ul v-for="(y,yIndex) in x.options" v-show="x.qustion.typeArr&&(x.qustion.typeArr.includes('1')||x.qustion.typeArr.includes('2'))">
                    ...
                    <el-input style="margin-top:5px;" type="textarea" v-show="x.qustion.typeArr&&(x.qustion.typeArr.includes('3'))"
    ...
    methods: {
      ...
      saveInfo() {
        ...
        if (this.obj.title.length > 50) {
          this.$message.error("问卷标题长度不能大于50个字符！");
          return false;
        }
        if (!this.obj.introduction) {
          this.$message.error("请输入问卷宣传内容！");
          return false;
        }
        ...
        if (this.isAccuratePush && this.checkedRoles.length == 0) {
          this.$message.error("您选择了精准推送，请选择角色！");
          return false;
        }
        ...
        let postData = {
          ...
          enterpriseId:this.selectedComIds.join(',')
        };
        if (this.isEdit) {
      ...
      getDetail(qnaId) {
        ...
        this.$post(`/tax/question/detail`, {
          ...
          if (data.success) {
            ...
            // 处理选择部分公司逻辑
            let  corpIds=data.bean.qna.enterpriseId;
              if(corpIds){
              this.isSelectCom=true;
              this.selectedComIds=corpIds.split(',');
...
vm.isSelectCom=vm.isAccuratePushfalse;
          vm.isEdit = false;
        }
      });
    }
