...
// window.localmymystorage.getItems=(key)=>window.localmystorage.getItem(`wx_tax_${key}`);

// window.localmystorage.setItems=(key,val)=>{
//   return window.localmystorage.setItem(`wx_tax_${key}`,val);
// };
